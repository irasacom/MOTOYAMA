...
$(window).ready(function() {
	...
	$.vegas('slideshow', {
	  backgrounds:[
		...
		{ src:'images/bg-slider/bg-11.jpg', fade:1000 },
		{ src:'images/bg-slider/bg-12.jpg', fade:1000 },
		{ src:'images/bg-slider/bg-13.jpg', fade:1000 },
		{ src:'images/bg-slider/bg-14.jpg', fade:1000 },
		{ src:'images/bg-slider/bg-15.jpg', fade:1000 },
		{ src:'images/bg-slider/bg-16.jpg', fade:1000 },
		{ src:'images/bg-slider/bg-17.jpg', fade:1000 },
		{ src:'images/bg-slider/bg-18.jpg', fade:1000 }
	  ]
	})();
});
